...
t1=Time_Predict('data/4class-7200.csv',seq_len=100,label_len=10,n_features=1)
[x_train,y_train,x_test,y_test]=t1.load_data()
t1.lstm(x_train,y_train,model_save='model/4class-7200_300_LSTM_100to10.h5',ep=300)
t1.rnn(x_train,y_train,model_save='model/4class-7200_300_rnn_100to10.h5',ep=300)
t1.cnn(x_train,y_train,model_save='model/4class-7200_300_cnn_100to10.h5',ep=300)
tp1=t1.predict_result('model/4class-7200_300_LSTM_100to10.h5',x_test)
tp2=t1.predict_result('model/4class-7200_300_rnn_100to10.h5',x_test)
tp3=t1.predict_result('model/4class-7200_300_cnn_100to10.h5',x_test)
t1.evalute(predicted_data=tp1,y_test=np.reshape(y_test,(y_test.shape[0],y_test.shape[1])),plot_result_name='picture/4class-7200_300_LSTM_100to10.png',picture_name='4class-7200_300_LSTM_100to10',model_name='LSTM')
t1.evalute(predicted_data=tp2,y_test=np.reshape(y_test,(y_test.shape[0],y_test.shape[1])),plot_result_name='picture/4class-7200_300_RNN_100to10.png',picture_name='4class-7200_300_RNN_100to10',model_name='RNN')
t1.evalute(predicted_data=tp3,y_test=np.reshape(y_test,(y_test.shape[0],y_test.shape[1])),plot_result_name='picture/4class-7200_300_CNN_100to10.png',picture_name='4class-7200_300_CNN_100to10',model_name='CNN')
