...
TP.cnn(x_train1,y_train1,'model/mutil_ctrl_cnn_300_100to10.h5',ep=300)
TP.rnn(x_train1,y_train1,'model/mutil_ctrl_rnn_300_100to10.h5',ep=300)

MTP=multi_Time_Predict('data/mutil.csv',100,10,n_features=2)
[x_train2,y_train2,x_test2,y_test2]=MTP.load_data()
MTP.cnn(x_train2,y_train2,'model/mutil_cnn_300_100to10.h5',ep=300)
MTP.rnn(x_train2,y_train2,'model/mutil_rnn_300_100to10.h5',ep=300)

tp1=TP.predict_result('model/mutil_ctrl_cnn_300_100to10.h5',x_test1)
tp2=TP.predict_result('model/mutil_ctrl_rnn_300_100to10.h5',x_test1)
mtp1=MTP.predict_result('model/mutil_cnn_300_100to10.h5',x_test2)
mtp2=MTP.predict_result('model/mutil_rnn_300_100to10.h5',x_test2)

TP.evalute(predicted_data=tp1,y_test=y_test1,plot_result_name='picture/mutil_ctrl_cnn_300_100to10.png',picture_name='mutil_ctrl_cnn_300_100to10',model_name='cnn')
TP.evalute(predicted_data=tp2,y_test=y_test1,plot_result_name='picture/mutil_ctrl_rnn_300_100to10.png',picture_name='mutil_ctrl_rnn_300_100to10',model_name='rnn')
MTP.evalute(predicted_data=mtp1,y_test=np.reshape(y_test2,(y_test2.shape[0],y_test2.shape[1])),plot_result_name='picture/mutil_cnn_300_100to10.png',picture_name='mutil_cnn_300_100to10',model_name='CNN')
MTP.evalute(predicted_data=mtp2,y_test=np.reshape(y_test2,(y_test2.shape[0],y_test2.shape[1])),plot_result_name='picture/mutil_rnn_300_100to10.png',picture_name='mutil_rnn_300_100to10',model_name='RNN')
